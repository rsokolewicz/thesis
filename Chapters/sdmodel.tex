...
\begin{multline}
    \hat{H}
        = \sum_{\mathclap{\{i,j\}\in\text{n.n.}}}\,\Big(\frac{J_{\text{ex}}}{n}\hat{\bb{S}}_i\cdot\hat{\bb{S}}_j - \frac{K}{2n}\left(\hat{{S}}_{z,i}\right)^2%\cdot\hat{\bb{S}}_{z,j}%-t_h \hat{c}_i^\dagger\hat{c}_j
...
\section[Gilbert Damping and spin-life time of conducting spins]{The relation between Gilbert Damping and spin-life time of conducting spins%
\sectionmark{Gilbert Damping and spin-life time of conducting spins}}
\sectionmark{Gilbert Damping and spin-life time of conducting spins}
\label{intro:gilbert}
