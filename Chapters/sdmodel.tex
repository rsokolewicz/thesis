...
\begin{align}
	\hslash \partial_t \bb{m}  & = \bb{m}\times\big(-\mu\,bb{H}_\text{ext}+KS \,\bb{m_z}+J_\text{sd}\mathcal{A}\,\bb{s}\big)
	\label{intro:eq:S1}
\end{align}
