%************************************************
\chapter{Numerical approach to calculating Spin-orbit torques two-dimensional antiferromagnets} % $\mathbb{ZNR}$
\chaptermark{Numerical approach to calculating Spin-orbit torques antiferromagnets}
%************************************************
\label{ch:summit}
