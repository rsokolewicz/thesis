...
\begin{figure}
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig2.pdf}}}
\caption{
...
\begin{figure}
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig3.pdf}}}
...
\begin{figure}
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig4.pdf}}}
...
\begin{figure}
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig5.pdf}}}
...
% \label{chap02:EOMAFM}
% \begin{align}
% \dot{\bb{m}}^\textrm{A}  & = \bb{H}^\textrm{A}\times \bb{m}^\textrm{A}+ (J_\text{sd}\mathcal{A}/\hslash)\, \bb{m}^\textrm{A}\times \bb{s}^\textrm{A},\\
% \dot{\bb{m}}^\textrm{B} & = \bb{H}^\textrm{B}\times \bb{m}^\textrm{B}+ (J_\text{sd}\mathcal{A}/\hslash)\, \bb{m}^\textrm{B}\times \bb{s}^\textrm{B},
% \end{align}
% \eml
...
\begin{align}
 & \dot{\bb{n}} = -2\frac{J_\textrm{ex}}{\hslash} \bb{n}\times\bb{m} +\bb{H}\times\bb{n}+\frac{J_\text{sd}\mathcal{A}}{\hslash}\lt(\bb{n}\times\bb{s}_++\bb{m}\times\bb{s}_-\rt),\n\\
 & \dot{\bb{m}} = \bb{H}\times\bb{m}+\frac{J_\text{sd}\mathcal{A}}{\hslash}\lt(\bb{m}\times\bb{s}_++\bb{n}\times\bb{s}_-\rt),
\label{chap02:AFMEOM}
\end{align}
...
\be
v= \frac{3}{2} t_h a/\hslash, \qquad \alpha_\textrm{R}= \frac{3}{2} \lambda , \qquad \Delta_\text{sd}=J_\text{sd}S.
\e
...
\begin{multline}
\delta\bb{s}_+\,= A_I(n_z^2)\,\hat{\bb{z}}\times \bb{I} + A'_I(n_z^2)\,\bb{n}_\para\times \lt[\bb{n}_\para\times \lt[\hat{\bb{z}}\times \bb{I}\rt]\rt]
+ B_\perp(n_z^2)\,\bb{n}_\perp\times \lt[\hat{\bb{z}}\times \bb{I}\rt]\\
+B_\para(n_z^2)\,\bb{n}_\para\times \lt[\hat{\bb{z}}\times \bb{I}\rt]+ C(n_z^2)\,\bb{n}_\para\times \lt[\bb{n}_\perp\times \lt[\hat{\bb{z}}\times \bb{I}\rt]\rt],
\label{chap02:symmetry}
\end{multline}
where we decompose the N\'eel vector $\bb{n}=\bb{n}_\para+\bb{n}_\perp$ into in-plane $\bb{n}_\para$ and perpendicular-to-the-plane $\bb{n}_\perp$ components. We parameterize $\bb{n}=(\cos\phi\sin\theta,\allowbreak \sin\phi\sin\theta, \allowbreak \cos\theta)^\top$, where $\theta$ is a polar angle and $\phi$ is an azimuthal angle. Consequently, we have $\bb{n}_\para=(\cos\phi\sin\theta,\sin\phi\sin\theta,0)^\top$ and $\bb{n}_\perp=(0,0,\cos\theta)^\top$.
...
\begin{figure}
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig6.pdf}}}
...
\begin{figure}
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig7.pdf}}}
...
\e
where $\eta=J_\text{sd}\mathcal{A}\Delta_\text{sd}\lambda /evh t_h^2$. 
...
\Big(\,a_I\,\hat{\bb{z}}\times \bb{j} + a'_I(n_z^2)\,\bb{n}_\para\times \lt[\bb{n}_\para\times \lt[\hat{\bb{z}}\times\bb{j}\rt]\rt]\\
+c(n_z^2)\,\bb{n}_\para\times \lt[\bb{n}_\perp\times \lt[\hat{\bb{z}}\times\bb{j}\rt]\rt]\Big),
\end{multline}
...
a'_I(n_z^2)\, \bb{n}\!\times\!\lt[\bb{n}_\para\!\times\! \lt[\bb{n}_\para\!\times\! \lt[\hat{\bb{z}}\!\times\! \bb{j}\rt]\rt]\rt]\n\\
 & \hspace{3cm}+c(n_z^2)\, \bb{n}\!\times\!\lt[\bb{n}_\para\!\times\! \lt[\bb{n}_\perp\!\times\! \lt[\hat{\bb{z}}\!\times\! \bb{j}\rt]\rt]\rt]\Big),
\label{chap02:torque_Tplus}\\
\bb{T}^m_+=\eta \Big(\, & a_I\bb{m} \!\times\!\lt[\hat{\bb{z}}\!\times\!\bb{j}\rt] + 
a'_I(n_z^2)\, \bb{m}\!\times\!\lt[\bb{n}_\para\!\times\! \lt[\bb{n}_\para\!\times\! \lt[\hat{\bb{z}}\!\times\! \bb{j}\rt]\rt]\rt]\n\\
 & \hspace{3cm}+c(n_z^2)\, \bb{m}\!\times\!\lt[\bb{n}_\para\!\times\! \lt[\bb{n}_\perp\!\times\! \lt[\hat{\bb{z}}\!\times\! \bb{j}\rt]\rt]\rt]\Big),
\label{chap02:torque_Tminus}
\end{align}
\eml
where $\eta=J_\text{sd}\mathcal{A}\Delta_\text{sd}\lambda /evh t_h^2$ is the same as in Eq.~(\ref{chap02:metal_SOT}). 
...
+\tilde{c}(n_z^2)\, \bb{n}\!\times\!\lt[\bb{n}_\para\!\times\! \lt[\bb{n}_\perp\!\times\! \lt[\hat{\bb{z}}\!\times\! \bb{j}\rt]\rt]\rt]\Big),
\e
where we introduced
\be
\label{chap02:renorm}
...
For numerical simulations we choose $\Delta_\text{sd}= J_\text{sd} S=0.1\,t_h$, $\lambda=0.05\,t_h$, and $V_\textrm{d}=0.5\,t_h$ as for the symmetric model. 
...
\be
\label{chap02:TA}
\bb{T}^\textrm{A}= \frac{J_\text{sd}\mathcal{A}}{\hslash} \bb{m}^\textrm{A}\times\delta\bb{s}^\textrm{A}= \frac{J_\text{sd}\mathcal{A}}{\hslash} \lt(\bb{n}+\bb{m}\rt)\times\lt(\delta\bb{s}_++\delta\bb{s}_-\rt),
\e
...
\begin{figure}
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig8.pdf}}}
...
\begin{figure}
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig9.pdf}}}
\caption{The Fermi surfaces for the asymmetric model for the metal regime $E=0.3\,t_h$ (right panel) and the half-metal regime $E=0.1\,t_h$ (left panel). The Fermi surfaces are not round due to tridiagonal wrapping originating in $C_{3v}$ point-group symmetry of the crystal and due to in-plane component $\bb{m}^\textrm{A}_\para$ that affects the spectrum. The plots correspond to the choice $\theta=-\phi=\pi/4$. The momentum $\bb{k}$ is measured with respect to $\bb{K}$ point (solid lines) and $\bb{K}'$ point (dashed lines).}
...
To do that we represent the vector $\bb{m}^\textrm{A}=\bb{m}_\para^\textrm{A}+\bb{m}_\perp^\textrm{A}$ as the sum of in-plane and perpendicular-to-the-plane components and decompose the numerical data with respect to the transformations: $\bb{m}_\perp^\textrm{A}\to -\bb{m}_\perp^\textrm{A}$ and $\bb{m}_\para^\textrm{A}=-\bb{m}_\para^\textrm{A}$. As the result, the non-equilibrium spin density (as the function of the vector components) is readily decomposed into the sum of four contributions,  
\be
\label{chap02:dec}
\delta\bb{s}^\textrm{A}[\bb{m}^\textrm{A}_\perp,\bb{m}^\textrm{A}_\para]= \delta\bb{s}_{++}+ \delta\bb{s}_{+-}+\delta\bb{s}_{-+}+\delta\bb{s}_{--},
\e
which are expressed as
\begin{multline}
\delta\bb{s}_{\zeta\kappa}=
\frac{1}{4}\Big(\delta\bb{s}^\textrm{A}[\bb{m}^\textrm{A}_\perp,\bb{m}^\textrm{A}_\para]+\zeta\, \delta\bb{s}^\textrm{A}[-\bb{m}^\textrm{A}_\perp,\bb{m}^\textrm{A}_\para]
+\kappa\, \delta\bb{s}^\textrm{A}[\bb{m}^\textrm{A}_\perp,-\bb{m}^\textrm{A}_\para]\\
+\zeta\kappa\, \delta\bb{s}^\textrm{A}[-\bb{m}^\textrm{A}_\perp,-\bb{m}^\textrm{A}_\para]\Big), 
\end{multline}
...
\begin{figure}
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig10.pdf}}}
...
\begin{multline}
\delta\bb{s}^\textrm{A}\,= A_I(n_z^2)\,\hat{\bb{z}}\times \bb{I} + A'_I(n_z^2)\,\bb{m}^\textrm{A}_\para\times \lt[\bb{m}^\textrm{A}_\para\times \lt[\hat{\bb{z}}\times \bb{I}\rt]\rt]
+ B_\perp(n_z^2)\,\bb{m}^\textrm{A}_\perp\times \lt[\hat{\bb{z}}\times \bb{I}\rt]\\+B_\para(n_z^2)\,\bb{m}^\textrm{A}_\para\times \lt[\hat{\bb{z}}\times \bb{I}\rt]+C(n_z^2)\,\bb{m}^\textrm{A}_\para\times \lt[\bb{m}^\textrm{A}_\perp\times \lt[\hat{\bb{z}}\times \bb{I}\rt]\rt],
\label{chap02:sA}
\end{multline}
where all coefficients are generally even functions of the component $n_z= n_z^\textrm{A}=\cos\theta$. Note that the first two vector forms are of the same symmetry with respect to both reflections $\bb{m}^\textrm{A}_\perp\to - \bb{m}^\textrm{A}_\perp$ and $\bb{m}^\textrm{A}_\para\to - \bb{m}^\textrm{A}_\para$.
...
\begin{figure}[t]
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{articles/sumit_paper/fig11.pdf}}}
...
\cite{roschewsky_spin-orbit_2016, roschewsky_spin-orbit_2017, kim_spin-orbit_2018}.  In particular, the contribution from both field-like and anti-damping-like torques have been identified in GdFeCo films with perpendicular magneto-crystalline anisotropy in both transition-metal and rare-earth-metal rich configurations \cite{roschewsky_spin-orbit_2016, roschewsky_spin-orbit_2017}. 
...
\begin{figure}[t]
\centering
\centerline{\includegraphics[width=0.7\columnwidth]{{gfx/Chapter02/fig12}}}
\caption{Time evolution of the in-plane N\'eel vector $\bb{n}_\para(t)$ in the symmetric model (top panel) and asymmetric model (bottom panel) induced by a 
...
\label{EOMAFM10}
\begin{align}
\dot{\bb{n}}^\text{A}  & = 2\frac{J_\text{ex}}{\hslash}\bb{n}^\text{B}\times \bb{n}^\text{A}+ \frac{J_\text{sd}\mathcal{A}}{\hslash}\, \bb{n}^\text{A}\times \bb{s}^\text{A} +\alpha\, \bb{n}^\text{A}\times \dot{\bb{n}}^\text{A},\\
\dot{\bb{n}}^\text{B} & = 2\frac{J_\text{ex}}{\hslash} \bb{n}^\text{A}\times \bb{n}^\text{B}+ \frac{J_\text{sd}\mathcal{A}}{\hslash}\, \bb{n}^\text{B}\times \bb{s}^\text{B}+\alpha\, \bb{n}^\text{B}\times \dot{\bb{n}}^\text{B},
\end{align}
\eml
