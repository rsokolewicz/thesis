...
These materials are often grouped in four distinct groups [spintronics book]: (i) graphene based, (ii) 2D chalcogenides [Proc Natl Acad Sci U S A. 2005;102:10451-10453
...
Apart from the crystals in Table~\ref{table:crystals}, there is also a large amount of two-dimensional crystals that are neither ferro or antiferromagnetic. The possibility to induce (anti)ferromagnetism in such a crystal is attractive as it give acces to even a wider range of material parameters. In general one can undertake two ways: doping and magnetic proximity [nature nanotechnology 9 794 (2014), prl 104 096804, nat phys 8 199, apl mater 4 032401, science 352 437]. The first is by chemically doping the crystal with $d$ or $f$ elements (e.g. Mn, Eu, Cr) or by introducing defects. For example, by doping GaAs with Mn atoms, exchange is introduced between local and delocalized spins giving rise to ferromagnetism [https://journals.aps.org/rmp/abstract/10.1103/RevModPhys.86.187]. A second approach is by bringing the crystal in viscinity with a (anti)ferromagnetic material. For example one can deposit graphene on top of an insulating ferromagnet such as YIG or EuS to create ferromagnetic graphene [https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.114.016603, https://iopscience.iop.org/article/10.1088/2053-1583/4/1/014001/meta]

In this thesis we are interested in the role of conducting electrons in assisting in the manipulation and relaxation of magnetic moments in ferro and antiferromagnets. Specifically, we study two-dimensional ferro and antiferromagnets where the conducting electrons have a linear energy dispersion. Such electrons are called Dirac electrons and the system as a whole is referred to as either Dirac ferro- or antiferromagnet. Dirac electrons were first found in graphene [graphene], soon after in topological insulators [?] and in many other classes of materials [?]. The Dirac ferromagnet that is studied in Chapter~\ref{diffusive} is inspired by a bilayer consisting of a topological insulator and a ferromagnetic insulator. The model can be directly used to describe for example a bilayer consisting of Bi$_2$Te$_3$ or Bi$_2$Se$_3$ and YIG or EuS. In Chapters~\ref{summit} and \ref{baglay} a particular antiferromagnet is studied on a honeycomb lattice. Although most of the antiferromagnets presented in Table~\ref{table:crystals} have a honeycomb lattice, the majority are unfortunately insulators. Furthermore, the remaining conducting antiferromagnets cannot be accurately described with a simple Dirac hamiltonian. The closest experimentally realized material would be CuMnAs that has a square lattice, but can host Dirac electrons. The results from Chapters~\ref{summit} and \ref{baglay} can at least qualitatively describe the current induced phenomena found in CuMnAs. Other Dirac antiferromagnets exist as well such as well (e.g. TaCoTe2 [https://journals.aps.org/prb/abstract/10.1103/PhysRevB.95.115138], Zr$_2$Si [%https://pubs.rsc.org/en/content/articlelanding/2018/cp/c7cp08108a#!divAbstract)]
], BaFe$_2$As$_2$ and SrFe$_2$As$_2$[https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.119.096401], EuCd$_2$As$_2$ [%https://onlinelibrary.wiley.com/doi/full/10.1002/adma.201907565?casa_token=pRwIe09TghgAAAAA%3ASLIOXukGo4WJOwC5MNXQmnD4d345pyV76pEKAMWnadsciP7FBVInHvxQPcfZNNZb_0xQY9HZtMxs-_jexw
], MnBi$_2$Te$_4$ [https://journals.aps.org/prb/abstract/10.1103/PhysRevB.101.161109]), but they suffer from symmetry protected gapless states and low exchange energies between localized and conducting electrons. As such, they are unideal when it comes to manipulating the antiferromagnetic order. Ideally our model would be directly applied to an antiferromagnetic version of graphene. Though such a version does not exist (yet), there are recent proposals however to realize it by bringing graphene in proximity with MnPSe3 [https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.124.136403] and by bringing it in double proximity between a layer of Cr2Ge2Te6 and WS2 [https://arxiv.org/pdf/1910.08072.pdf]
