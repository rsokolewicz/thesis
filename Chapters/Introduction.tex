...
\begin{figure}
    \centering
    \subcaptionbox{Ferro}{\includegraphics[width=0.2\textwidth]{gfx/hex_ferro}}%
    \hspace{0.05\textwidth}
    \subcaptionbox{N\'eel}{\includegraphics[width=0.2\textwidth]{gfx/hex_AFM_neel}}%
    \hspace{0.05\textwidth}
    \subcaptionbox{Zig-zag}{\includegraphics[width=0.2\textwidth]{gfx/hex_AFM_zigzag}}%
    \hspace{0.05\textwidth}
    \subcaptionbox{Stripy}{\includegraphics[width=0.2\textwidth]{gfx/hex_AFM_stripy}}%
